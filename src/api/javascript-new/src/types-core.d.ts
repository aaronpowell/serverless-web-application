...
declare module "@azure/functions-core" {
  ...
  function registerHook(
    ...
    callback: PreInvocationCallback
  ): Disposable;
  function registerHook(
  ...
  function registerHook(
    hookName: "appStart",
    callback: AppStartCallback
  ): Disposable;
  function registerHook(
    hookName: "appTerminate",
  ...
  type PreInvocationCallback = (
    context: PreInvocationContext
  ) => void | Promise<void>;
  type PostInvocationCallback = (
    context: PostInvocationContext
  ) => void | Promise<void>;
  type AppStartCallback = (context: AppStartContext) => void | Promise<void>;
  type AppTerminateCallback = (
    context: AppTerminateContext
  ) => void | Promise<void>;
